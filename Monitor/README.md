# Monitor - CBT Thought Reframing App

A minimal vertical slice implementation of a CBT-based iOS app for capturing and Monitoring anxious thoughts.

Based on David Burns' "Feeling Good" framework - Monitor cognitive distortions and find balanced perspectives.
...
### 2. Add Files
Copy the files from the Monitor/ directory into your Xcode project, maintaining the folder structure.
...
### 4. Update MonitorApp.swift
Replace the default app file with our MonitorApp.swift
...
### First Launch:
1. You'll see empty state with "Welcome to Monitor"
