...
- Symptoms of psychosis or dissociation
...
- If you have questions about your mental health
- If you're considering changes to treatment or medication
- If your symptoms worsen or don't improve

## Privacy and Data

Your privacy is paramount. Please review our [Privacy Policy](PRIVACY_POLICY.md) to understand how we handle (or rather, don't handle) your data.

**Key Privacy Points:**
- All your mental health data stays on your device
- We don't collect, store, or access your thoughts or reframes
- Optional feedback is the only data that leaves your device
...
- Not to attempt to hack, reverse engineer, or break the App
...
- Subject to scientific evolution (what we know about CBT may change)

We strive for accuracy but make no guarantees that the content is:
...
- Change the UI or functionality
- Update content and educational materials
- Release new versions

We'll try to notify you of major changes, but continued use of the App means you accept those changes.
...
- **Merchantability** - We don't guarantee the App is suitable for any purpose
- **Fitness for a particular purpose** - We don't guarantee it will help your mental health
...
- Damage to your device or other property
...
### Specific Mental Health Limitation
We are specifically NOT liable for:
- Any worsening of mental health symptoms
- Any delay in seeking professional treatment
- Any reliance on the App instead of professional care
- Any harm resulting from misuse of CBT techniques
- Any crisis or emergency not addressed by professional services

**If the App doesn't help you, or makes things worse, stop using it and seek professional help.**

### Jurisdictional Limitations
Some jurisdictions don't allow limitation of liability for certain damages. In those jurisdictions, our liability is limited to the fullest extent permitted by law.
...
- **Support development** - Donations help cover hosting costs, Apple Developer fees, and development time

### Ko-fi Terms
Donations are processed by Ko-fi and subject to:
- Ko-fi Terms of Service: https://ko-fi.com/home/terms
- Ko-fi Privacy Policy: https://ko-fi.com/home/privacy
- Payment processor terms (Stripe or PayPal)
...
- Cover Apple Developer Program fees ($99/year)
- Maintain AWS infrastructure for the feedback API
- Invest time in updates, bug fixes, and improvements
- Keep the app free and privacy-first (no ads, no data selling, no paywalls)

### No Commitment to Updates
While we appreciate donations:
- We are not obligated to provide specific features, updates, or support
- We reserve the right to discontinue the app at any time
- We will never introduce paywalls, subscriptions, or feature-gating
...
- Any feedback or content you submit
...
We reserve the right to:
- Disable the feedback API for abusive users
- Discontinue the App at any time
- Block access for Terms violations

Upon termination:
- Your local data remains on your device
- You must stop using the App
- These Terms survive (privacy, intellectual property, limitations)
...
### Jurisdiction
For non-arbitrable disputes, you agree to the exclusive jurisdiction of the courts in New Bedford, Massachusetts.

## Feedback and Suggestions

We welcome your feedback! If you send us ideas, suggestions, or feedback:
- You grant us the right to use it without compensation
- You represent that it's your original idea
- You waive any confidentiality
- We're not obligated to use it

We appreciate your input and will consider all feedback, but we can't promise we'll implement everything.
...
If there's a conflict between these Terms and Apple's terms, Apple's terms prevail for App Store-related issues.

## Third-Party Services

The App uses AWS (Amazon Web Services) for the optional feedback feature. AWS's terms and privacy policy also apply to that specific feature:
...
5. **We're not liable** - If something goes wrong, we're not responsible for damages.
