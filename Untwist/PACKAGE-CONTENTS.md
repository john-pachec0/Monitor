# Untwist - Complete Package Contents
...
1. **UntwistApp.swift** - Main app entry point with SwiftData configuration
...
7. **REBRAND.md** - What changed from Clarity to Untwist
...
```bash
# For .tar.gz
tar -xzf Untwist-Complete.tar.gz

# For .zip
unzip Untwist-Complete.zip
```
...
**Untwist** is a CBT-based iOS app that helps you:
...
- Initial MVP release
- Complete rebrand from Clarity to Untwist
...
**Ready to untwist some thoughts!** 🧠✨
