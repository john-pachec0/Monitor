# Untwist Update - Onboarding + Improvements
...
1. `UntwistApp.swift` - Updated to show onboarding
...
1. **Add UserSettings.swift**:
   ...
   - Ensure target "Untwist" is checked
...
3. **Replace Updated Files**:
   - Delete old `UntwistApp.swift` from Xcode (Move to Trash)
   - Drag new `UntwistApp.swift` to root level
